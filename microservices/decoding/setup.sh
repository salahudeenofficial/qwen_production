...
# setup.sh - Setup ComfyUI modules and download models for decoding service
...
# Additional dependencies for decoding microservice
ADDITIONAL_DEPS=(
    "# Additional packages required for decoding microservice"
...
echo "     --latent test_outputs/sampling_output.pt \\"
echo "     --output_filename test_output \\"
echo "     --output_format jpg"
echo ""
