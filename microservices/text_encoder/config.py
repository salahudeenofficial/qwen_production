...
class Config:
    ...
    kafka_request_topic = os.getenv("KAFKA_REQUEST_TOPIC", "text-encoder-requests")
    kafka_response_topic = os.getenv("KAFKA_RESPONSE_TOPIC", "text-encoder-responses")
    kafka_consumer_group = os.getenv("KAFKA_CONSUMER_GROUP", "text-encoder-group")
