...
# setup.sh - Setup ComfyUI modules and download models for text encoder service
...
echo "=========================================="
echo "Text Encoder Service Setup"
echo "=========================================="
...
# Additional dependencies for text encoder microservice
ADDITIONAL_DEPS=(
    "# Additional packages required for text_encoder microservice"
...
echo "✓ Models downloaded (CLIP + VAE)"
echo ""
echo "Virtual environment: $VENV_DIR"
...
echo "   python main.py --mode standalone --image1_path <path_to_image1> --image2_path <path_to_image2> --prompt \"your prompt here\""
echo ""
